...
export class GalleryController {
    ...
    //         // Upload new image
    //         const fileUploadResult = await CommonController.uploadDocuments(req, res);
    //         if (!fileUploadResult.status || !fileUploadResult.files.length) {
    //             return res.status(400).json({
    //                 success: false,
    //                 message: fileUploadResult.message || "No files uploaded",
    //             });
    //         }
    ...
    //         const updateImageByImgId = (mealArray: any[] = []) => {
    //             let updated = false;
    //             const updatedArray = mealArray.map(item => {
    //                 if (item.imgId === imgId) {
    //                     updated = true;
    ...
    //         if (morningMeal === "true" || morningMeal === true) {
    //             const { updatedArray, updated: isUpdated } = updateImageByImgId(existingGalleryDetails.morningMeal || []);
    //             existingGalleryDetails.morningMeal = updatedArray;
    //             updated = updated || isUpdated;
    //         }
    
    //         if (afternoonMeal === "true" || afternoonMeal === true) {
    //             const { updatedArray, updated: isUpdated } = updateImageByImgId(existingGalleryDetails.afternoonMeal || []);
    //             existingGalleryDetails.afternoonMeal = updatedArray;
    //             updated = updated || isUpdated;
    //         }
    
    //         if (eveningMeal === "true" || eveningMeal === true) {
    //             const { updatedArray, updated: isUpdated } = updateImageByImgId(existingGalleryDetails.eveningMeal || []);
    //             existingGalleryDetails.eveningMeal = updatedArray;
    //             updated = updated || isUpdated;
    //         }
    ...
    //             return res.status(404).json({
    //                 success: false,
    //                 message: "Image with specified imgId not found in the selected meal category",
    //             });
    //         }
